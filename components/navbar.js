...
function themeSwitcher() {
    return `                    <li class="nav-item d-flex aling-center"><a id="theme-switch" class="nav-link d-xxl-flex justify-content-xxl-center align-items-xxl-center active" href="#"><svg id="light-icon" class="me-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
        ...
        </svg><svg id="dark-icon" class="me-1" xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor">
...
function nav(t,rota) {
    ...
    <div class="dropdown-menu shadow" data-bs-popper="none"><a class="dropdown-item d-flex justify-content-sm-start" href="https://rpg.arkanus.app" rel="help" data-bs-target="https://rpg.arkanus.app">
            ...
            <div class="d-flex justify-content-center align-items-center m-2"><svg class="fs-1 border rounded border-0 p-2 me-2 nav_icon_background" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                ...
                <li class="nav-item"><a class="nav-link d-xxl-flex justify-content-xxl-center align-items-xxl-center active" href="/#inicio"><svg class="me-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 -64 640 640" width="1em" height="1em" fill="currentColor">
